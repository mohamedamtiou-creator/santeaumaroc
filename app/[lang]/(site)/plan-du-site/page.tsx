    ...
    groups: [
      ...
      },
      {
        ...
        links: [
          ...
          { href: "/traitements", label: "Traitements", desc: "Repères sur les traitements : principe, indications et bon usage." },
          { href: "/prix", label: "Prix des soins", desc: "Fourchettes indicatives des consultations et examens, et remboursement AMO/CNSS." },
          { href: "/glossaire", label: "Glossaire médical", desc: "Définitions claires et vérifiées des termes médicaux courants." },
    ...
    groups: [
      ...
      },
      {
        ...
        links: [
          ...
          { href: "/traitements", label: "العلاجات", desc: "معالم حول العلاجات: المبدأ، الدواعي والاستعمال السليم." },
          { href: "/prix", label: "أسعار العلاجات", desc: "نطاقات إرشادية للاستشارات والفحوصات، وتعويض AMO/CNSS." },
          { href: "/glossaire", label: "معجم طبي", desc: "تعريفات واضحة وموثوقة للمصطلحات الطبية الشائعة." },
